...
const data ={
  ...
  const {nom,prenom,numero_badget} = info ;
  axios.post(`${process.env.REACT_APP_URL_BADGET_INC}`,{
        nom             :nom,
        prenom          :prenom ,
  ...
  },
  {
    ...
    const {nom,numero_badget,prenom} = info ;
    const Btn_envoyer = nom === '' || numero_badget === '' || prenom === ''?
